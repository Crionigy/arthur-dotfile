...
;let D,L,M,N=!1,O=null;const P=b,Q=c;let R,S=null,T=!1,U=!1,V=null,W="";const X=(0,t.tG)();let Y=null;let Z=null;return{
Activate:function(){if(y)return;y=!0,(0,j.P7)().editorInSeparateTab?(0,r.l5)(Q):(0,
t.C)((()=>P.classList.add("rf-editor-inline-shown")))},Deactivate:function(){if(!y)return;af(),ad(),ab(),y=!1,
null==Y||Y.Cancel(),Y=null,(0,j.P7)().editorInSeparateTab?(0,r.SE)(Q):(B.GetController(1).Collapse(null),(0,
t.C)((()=>P.classList.remove("rf-editor-inline-shown"))));!function(a){if((0,j.P7)().editorInSeparateTab)return
;if(window.innerWidth<H)return;const b=(0,v.TT)(a);if(!b)return;F&&function(a){if(window.innerWidth>=H){
const b=A.m_page_preferences;(0,t.fI)(b.SetValue("StartPage.InlineEditorWidth",(0,v.bf)(a.clientWidth)))}}(b);(0,
e.dR)("hide-inline-editor",b,"left",b.offsetLeft,window.innerWidth,I,(()=>{b.style.width="",b.style.left=""}))
;const c=A.m_main_view_html_elements.header;(0,e.dR)("hide-inline-editor",c,"width",c.offsetWidth,window.innerWidth,I,(()=>{
c.style.width=""}));const d=A.m_main_view_html_elements.mainFrame
;(0,e.dR)("hide-inline-editor",d,"width",d.offsetWidth,window.innerWidth,I,(()=>{d.style.width=""}))}(S)},
UpdateView:function(a){a&&(z=!1);if(!y)return;if(O)return void(z=!0);if(M)return void(z=!0)
;if(!C.m_rf_data_editor_info.IsUptodate()||!z){const b=D?D.path:"",c=L||!1;(0,t.fI)(async function(a,b,c){if(O)return
;if(!Z||a)try{const a=await C.m_rf_service.GetRFOnlineUserId();if(Z){
if(Z.userId!==a.userId||Z.serverUrl!==a.serverUrl)return void C.m_rf_manager.CloseEditor()}else Z=a}catch(d){(0,u.r5)(d,u.kd)}
try{if(await C.m_rf_data_editor_info.Update("update-editor-info",b,null),!aa({path:b,editMode:c}))throw(0,u.JS)()
...
IsStillActual:aa,GetIsStillActual:function(){if(O)return()=>!0;let a,b;D&&(a=D.path,b=L||!1);return function(){return aa({
path:a,editMode:b})}},InitEditor:function(a,b,c,d,g){const h=(0,t.f4)(null,null,null);S||(S=x("div",{className:"rf-editor"}),
A.m_main_view_html_elements.editor=S,(0,j.P7)().editorInSeparateTab?(S.classList.add("rf-editor-page"),
Q.appendChild(S)):P.appendChild(S))
;const k=D?D.path:void 0,l=L||!1,o=N,p="stand-alone"===A.m_rf_page_status.extensionMode,q="stand-alone"===A.m_rf_page_status.mode
;let r=!1;if((void 0!==a.path||k!==a.path)&&g&&b){
const c=(0,i.k)(a,b,C.m_rf_cache,C.m_sharing_api,A.m_rf_api.data,C.m_clipboard);(0,t.fI)(ac((()=>c),h)),
C.m_rf_data_editor_info.Invalidate(),C.m_rf_data_editor_data.Invalidate()}else if(void 0===a.path||k!==a.path||l!==c||o!==g){
try{switch(a.type){case 2:(0,t.fI)((async()=>{try{const d=await(0,e.As)(m.Aj,300,h);if(c){
const c=d.BookmarkEditorView(a,b,!1,A.m_rf_data_item_images,A.m_rf_api.data,A.m_rf_api.usageInfo,(0,
j.P7)().editorInSeparateTab,{ShowNotification:ag,ShowErrorDialog:ah,ShowDataViewModeInDetailsPane:aA,ShowConfirmationDialog:aB
},A.m_localization);await ac((()=>c),h)}else{
const c=d.BookmarkViewerView(a,b,A.m_rf_data_item_images,A.m_rf_api.data,A.m_rf_api.usageInfo,A.m_rf_commands,!0,p,(0,
j.P7)().editorInSeparateTab,A.m_localization,C.m_clipboard,{ShowNotification:ag,ShowConfirmationDialog:aB,ShowErrorDialog:ah,
GetBookmarkCommands:ai,ShowDataEditModeInDetailsPane:az});await ac((()=>c),h)}}catch(d){ab(),(0,u.r5)(d,u.kd)||await(0,
...
j.P7)().editorInSeparateTab,A.m_localization,C.m_clipboard,{ShowNotification:ag,ShowConfirmationDialog:aB,ShowErrorDialog:ah,
ShowDataViewModeInDetailsPane:aA});await ac((()=>c),h)}else{
const c=d.LoginViewerView(a,b,A.m_rf_data_item_images,A.m_view_api,A.m_rf_api.data,A.m_rf_api.usageInfo,A.m_rf_commands,A.password_audit_service,A.m_rf_api.securityWarningsManager,A.m_breach_mon_service,!0,p,q,(0,
j.P7)().editorInSeparateTab,!1,C.m_localization,C.m_clipboard,{ShowNotification:ag,ShowConfirmationDialog:aB,ShowErrorDialog:ah,
GetLoginCommands:ai,GetDataLoginPasswordStrength:ax,GetTextByPasswordStrength:ay,ShowDataEditModeInDetailsPane:az,
CopyTextToClipboardWithAutoClear:aC,OpenSecurityCenter:()=>aD(a.path),OpenDataBreachMonitoring:aE});await ac((()=>c),h)}
}catch(d){ab(),(0,u.r5)(d,u.kd)||await(0,f.nn)("Cannot open Login Editor: "+(0,u.EB)(d))}})());break;case 5:(0,t.fI)((async()=>{
try{d?await aI(a,b,h):await aH(a,b,"","",h)}catch(c){ab(),(0,u.r5)(c,u.kd)||await(0,f.nn)("Cannot open Identity Editor: "+(0,
u.EB)(c))}})());break;case 6:(0,t.fI)((async()=>{try{d?await aI(a,b,h):await aH(a,b,"","",h)}catch(c){ab(),(0,
u.r5)(c,u.kd)||await(0,f.nn)("Cannot open Identity Editor: "+(0,u.EB)(c))}})());break;case 7:{const c=b?null:{path:(0,
s.fA)(a.path),type:0};r=!d,(0,t.fI)((async()=>{try{
...
j.P7)().editorInSeparateTab,A.m_localization,{ShowNotification:ag,ShowConfirmationDialog:aB,ShowErrorDialog:ah,
ShowModalDialog:aF,GetSafenoteCommands:aj,CopyTextToClipboard:a=>aC(a,null),OnCreate:async b=>{
const c=await A.m_rf_api.data.GetDataItem(b.path,4,null,null);A.m_rf_manager.OnEditorItemCreated(a,b),await aA(b,c,!1,h)}})
;await ac((()=>f),h)}catch(g){ab(),(0,u.r5)(g,u.kd)||await(0,f.nn)("Cannot open Safenote Editor: "+(0,u.EB)(g))}})())}break
;default:throw(0,u.ZU)(u.V2,"unexpected data type")}}catch(v){return(0,w.Rm)("!!! Cannot open editor",v),(0,t.fI)((0,
f.nn)(C.m_localization.LocalizeString("StartPage_OpenEditor_Error",[(0,n.XE)(a.path,!1),(0,u.EB)(v)]))),!1}
C.m_rf_data_editor_info.Invalidate(),C.m_rf_data_editor_data.Invalidate()}M=d||!1,D=a,L=c,N=g,O=null,
(void 0===a.path||k!==a.path)&&((0,t.fI)(C.m_ui_commands.LogGroupFileAccess(a,"View")),r&&(0,
t.fI)(C.m_ui_commands.UpdateDataItemUsedUsageInfo(a)));return!0},InitEditorWithCustomView:function(a){if(O===a)return
;S||(S=x("div",{className:"rf-editor"}),A.m_main_view_html_elements.editor=S,(0,
j.P7)().editorInSeparateTab?Q.appendChild(S):P.appendChild(S));O=a,D=void 0;const b=function(a){const b={Create:c,OnAfterShow:d,
OnBeforeHide:e,Focus:f,Dispose:g};return b;async function c(){return x("div",null,a)}function d(){}function e(){}function f(){}
function g(){}}(a),c=(0,t.f4)(null,null,null);(0,t.fI)(ac((()=>b),c))},UninitEditor:ab,IsEditorInitialized:function(){
return void 0!==D||null!==O},ItemRenamed:function(a){D&&(D.path=a)},ItemCreated:function(a,b){aa({path:a.path,editMode:!1
})&&(D=b,M=!1)},OnChanges:function(a){if(!y)return;if(!a)return;if(O)return;const b=D;if(!b)return;const c=b.path
;for(let d=0;d<a.length;d++){const e=a[d];if(8===e.event)c===e.path&&e.to&&(b.path=(0,v.TT)(e.to.path),b.type=(0,n.hF)((0,
v.TT)(e.to.path)))}},GetState:function(){if(O)return{m_mode:"custom",m_in_separate_tab:(0,j.P7)().editorInSeparateTab}
;if(!D)return null;return{m_item_info:D,m_mode:M?"create":L?"edit":N?"item history":"view",m_in_separate_tab:(0,
j.P7)().editorInSeparateTab}},SetEditorSize:function(a){if((0,j.P7)().editorInSeparateTab)return;if(!S)return;E=a}}
;function aa(a){if(!y)return!1;if(O)return!0;const b=a&&a.path,c=a&&a.editMode;if(void 0===b)return!0
;if(!(D&&D.path===b))return!1;return!((L||!1)!==c)}function ab(){D=void 0,L=void 0,Z=null,T=!1,O=null}async function ac(a,b){
return(0,t.W0)((async(b,c,d)=>{if(S&&(d.onTaskCancel.Add((()=>{f((0,u.JS)())})),R&&R.Dispose(),R=(0,
k.BQ)((async(a,b,c)=>x("div",{className:"details-view"},await a.Create(b,c))),a(d)),function(){if(!V)return void(U=!1)
;null==S||S.removeChild((0,v.TT)(V)),U=!1,V=null}(),V=await R.Create((function(a){b(a),ae()}),f),
!d.ShouldStop()))return await async function(){const a=Boolean(E);if(T&&a===G)return void(E=null);F=!a;T=!0,
S&&await async function(a){if((0,j.P7)().editorInSeparateTab)return;if(window.innerWidth<H)return;const b=(0,v.TT)(a)
;if(!b)return;let c;if(E)c=E;else{const a=A.m_page_preferences;c=parseInt(await a.GetValue("StartPage.InlineEditorWidth",""))||0
}K(c);const d=J(c);b.style.width=(0,q.Md)(d),(0,e.dR)("show-inline-editor",b,"left",b.offsetLeft,window.innerWidth-d,I)
;const f=A.m_main_view_html_elements.header;(0,e.dR)("show-inline-editor",f,"width",f.offsetWidth,window.innerWidth-d,I)
;const g=A.m_main_view_html_elements.mainFrame;(0,e.dR)("show-inline-editor",g,"width",g.offsetWidth,window.innerWidth-d,I)}(S)
;!function(){if((0,j.P7)().editorInSeparateTab)return;const a=x("div",{className:"rf-resize-handle"});function b(a){S&&((0,
j.P7)().editorInSeparateTab||(a.preventDefault(),function(a,b){if((0,j.P7)().editorInSeparateTab)return;if(!a)return;K(b),
b=J(b),a.style.width=(0,q.Md)(b),a.style.left=(0,q.Md)(window.innerWidth-b);A.m_main_view_html_elements.header.style.width=(0,
q.Md)(window.innerWidth-b);A.m_main_view_html_elements.mainFrame.style.width=(0,q.Md)(window.innerWidth-b),
A.m_rf_manager.OnEditorResized()}(S,window.innerWidth-a.clientX)))}null==S||S.appendChild(a),
a.addEventListener("mousedown",(a=>{T&&(a.preventDefault(),document.body.style.cursor="e-resize",
document.addEventListener("mousemove",b))})),document.addEventListener("mouseup",(()=>{document.body.style.cursor="",
document.removeEventListener("mousemove",b)}))}()}(),S.appendChild(V),U=!0,V.focus(),R.OnAfterShow(),void R.Focus()
;function f(a){try{c(a)}finally{ae()}}}),b)}function ad(){U&&R&&(R.OnBeforeHide(),R.Dispose())}function ae(){
T&&A.m_rf_manager.CloseEditor()}function af(){const a=null==S?void 0:S.querySelector(".rf-resize-handle")
;a&&(null==S||S.removeChild(a))}function ag(a){(0,e.Fp)(a)}async function ah(a){
const b=A.m_localization.LocalizeString,c=await b("AdminCenter_ErrorDialog_Title"),d=await b("StartPage_DialogButton_Ok")
;return aF((0,l.Sw)((0,v.TT)(P),(0,l.p)((0,l.dK)("dialog-modal",c,null),(()=>(0,k._3)((async(b,c)=>x("div",{className:"content"
},x("div",{className:"confirmation-text"},a),x("div",{className:"buttons-bar"},x("div",{className:"button default-button",
onclick:()=>b()},d)))))))),null)}async function ai(a,b){const c=[],d=await(0,h._w)(a);let e=!1
;return d.viewInNewTabAllowed&&(await al(a,c,null),c.push("separator")),d.shareAllowed&&(await am(a,c,null),e=!0),
d.sendAllowed&&(await an(a,c,null),e=!0),d.printAllowed&&(await ao(a,c),e=!0),e&&(c.push("separator"),e=!1),
d.openFileLocationAllowed&&(await ap(a,c),e=!0),e&&(c.push("separator"),e=!1),d.renameAllowed&&await aq(c,b),
d.moveAllowed&&await ar(a,c),d.cloneAllowed&&await as(a,c),d.pinAllowed&&await at(a,c),d.unpinAllowed&&await au(a,c),
d.deleteAllowed&&await av(a,c),d.viewBackupHistoryAllowed&&!M&&(c.push("separator"),await aw(a,c)),c}async function aj(a,b,c,d){
const e=[],f=await(0,h._w)(a);let g=!1;return f.viewInNewTabAllowed&&(await al(a,e,d),e.push("separator")),
f.shareAllowed&&(await am(a,e,d),g=!0),f.sendAllowed&&(await an(a,e,d),g=!0),f.printAllowed&&(await ao(a,e),g=!0),
g&&(e.push("separator"),g=!1),f.openFileLocationAllowed&&(await ap(a,e),g=!0),g&&(e.push("separator"),g=!1),
f.renameAllowed&&await aq(e,c),f.moveAllowed&&!b&&await ar(a,e),f.cloneAllowed&&!b&&await as(a,e),
f.pinAllowed&&!b&&await at(a,e),f.unpinAllowed&&await au(a,e),f.deleteAllowed&&!b&&await av(a,e),
f.viewBackupHistoryAllowed&&!b&&(e.push("separator"),await aw(a,e)),e}async function ak(a,b,c){
const d=A.m_localization.LocalizeString,e=[],f=await(0,h._w)(a);let g=!1;return f.shareAllowed&&(await am(a,e,null),g=!0),
f.sendAllowed&&(await an(a,e,null),g=!0),f.printAllowed&&(await ao(a,e),g=!0),g&&(e.push("separator"),g=!1),
f.openFileLocationAllowed&&(await ap(a,e),g=!0),g&&(e.push("separator"),g=!1),f.renameAllowed&&await aq(e,(()=>(0,t.fI)(b()))),
f.moveAllowed&&await ar(a,e),f.cloneAllowed&&await as(a,e),e.push({title:await d("AdminCenter_CopyAllFields_Text"),
imageClass:"cmd-copy-icon",onCommand:async(b,c)=>{const e=await A.m_rf_api.data.GetDataItem(a.path,4,null,c);try{
const a=await(0,n._1)(e,C.m_identity_view_structure_loader,A.m_localization);await aC(a,12e4)
;ag(await d("Notification_Identity_Fields_Copyied_Text"))}catch(f){ag((0,p.Qo)(f))}}}),f.changeCountryAllowed&&e.push({
title:await d("Identities_ChangeCountry_Title"),imageClass:"cmd-change-country",onCommand:c}),f.pinAllowed&&await at(a,e),
f.unpinAllowed&&await au(a,e),f.deleteAllowed&&await av(a,e),f.viewBackupHistoryAllowed&&!M&&(e.push("separator"),
await aw(a,e)),e}async function al(a,b,c){const d=A.m_localization.LocalizeString;b.push({
title:await d("StartPage_EditorInSeparateTab"),imageClass:"cmd-view-new-tab-icon",onCommand:async b=>{if(M){
const b=await d("StartPage_Safenote_SaveNewBeforeActionConfirm",[await(0,e.en)(a.type,A.m_localization)])
;if(await aB(await d("AdminCenter_SaveChanges_Text"),b,await d("AdminCenter_ConfirmationDialog_DontSave"),await d("AdminCenter_ConfirmationDialog_Save"))&&c){
const a=await c();a&&A.m_rf_manager.OnOpenEditor(a,!1,!1,!0)}}else A.m_rf_manager.OnOpenEditor(a,!1,!1,!0)}})}
async function am(a,b,c){const f=A.m_localization.LocalizeString;b.push({title:await f("StartPage_Cmd_Share"),
imageClass:"cmd-share-icon",onCommand:async b=>{if(M){const b=await f("StartPage_Safenote_SaveNewBeforeActionConfirm",[await(0,
e.en)(a.type,A.m_localization)])
;if(await aB(await f("AdminCenter_SaveChanges_Text"),b,await f("AdminCenter_ConfirmationDialog_DontSave"),await f("AdminCenter_ConfirmationDialog_Save"))&&c){
const a=await c();a&&await(0,d.RE)(A.m_ui_commands,a)}}else await(0,d.RE)(A.m_ui_commands,a)}})}async function an(a,b,c){
const f=A.m_localization.LocalizeString;b.push({title:await f("Cmd_SendFile_Flat"),imageClass:"cmd-send-icon",
onCommand:async b=>{if(M){const b=await f("StartPage_Safenote_SaveNewBeforeActionConfirm",[await(0,
e.en)(a.type,A.m_localization)])
;if(await aB(await f("AdminCenter_SaveChanges_Text"),b,await f("AdminCenter_ConfirmationDialog_DontSave"),await f("AdminCenter_ConfirmationDialog_Save"))&&c){
const a=await c();a&&await(0,d.eh)(A.m_ui_commands,a)}}else await(0,d.eh)(A.m_ui_commands,a)}})}async function ao(a,b){
const c=A.m_localization.LocalizeString;b.push({title:await c("Cmd_PrintCurrent_Flat"),imageClass:"cmd-print-icon",
onCommand:async b=>{A.m_ui_commands.Print(a)}})}async function ap(a,b){const c=A.m_localization.LocalizeString;b.push({
title:await c("Cmd_OpenFileLocation_Flat"),imageClass:"cmd-open-file-location-icon",onCommand:async b=>{
A.m_rf_manager.OpenFileLocation(a)}})}async function aq(a,b){const c=A.m_localization.LocalizeString;a.push({
title:await c("Cmd_Rename_Flat"),imageClass:"cmd-rename-icon",onCommand:async()=>b()})}async function ar(a,b){
...
localization:A.m_localization},{OnBeforeMoveOrClone:g.Xc});a.path=b}catch(b){}}(a)}})}async function as(a,b){
...
;await(0,g.OF)(a.path,b,A.m_rf_manager,A.m_rf_cached_data_info,A.m_localization)}catch(b){}}(a)}})}async function at(a,b){
const c=A.m_localization.LocalizeString;b.push({title:await c("StartPage_Cmd_AddToPinned"),imageClass:"cmd-pin-icon",
onCommand:async b=>{A.m_ui_commands.PinItem(!0,a)}})}async function au(a,b){const c=A.m_localization.LocalizeString;b.push({
title:await c("StartPage_Cmd_RemoveFromPinned"),imageClass:"cmd-unpin-icon",onCommand:async b=>{A.m_ui_commands.PinItem(!1,a)}})
}async function av(a,b){const c=A.m_localization.LocalizeString;b.push({title:await c("Cmd_Delete_Flat"),
imageClass:"cmd-delete-icon",onCommand:async b=>{await(0,d.DR)(a,A.m_ui_commands,A.m_rf_manager,A.m_localization)}})}
async function aw(a,b){const c=A.m_localization.LocalizeString;b.push({title:await c("StartPage_Cmd_ViewBackupHistory"),
...
;await A.m_rf_manager.SwitchToEditor(a,!1,!0)}})}async function ax(a){try{
return(await A.password_audit_service.GetUpdatePasswordStrengthInfo(a,null)).strength}catch(b){return null}}
async function ay(a){const b=A.m_localization.LocalizeString;switch((0,e.vA)(a)){case"strong":
return b("PassAud_PwdStrengthStrong");case"good":return b("PassAud_PwdStrengthGood");case"medium":
return b("PassAud_PwdStrengthMedium");default:return b("PassAud_PwdStrengthWeak")}}async function az(a,b,c,d){
if(2===a.type||1===a.type||4===a.type)if(D=a,L=!0,2!==a.type)if(1!==a.type&&4!==a.type);else{const f=(await(0,
e.As)(m.Rj,300,d)).LoginEditorView(a,b,c,A.m_rf_data_item_images,A.m_rf_api.data,A.m_rf_api.usageInfo,A.m_view_api,(0,
j.P7)().editorInSeparateTab,A.m_localization,C.m_clipboard,{ShowNotification:ag,ShowConfirmationDialog:aB,ShowErrorDialog:ah,
ShowDataViewModeInDetailsPane:aA});await ac((()=>f),d)}else{
const f=(await(0,e.As)(m.Aj,300,d)).BookmarkEditorView(a,b,c,A.m_rf_data_item_images,A.m_rf_api.data,A.m_rf_api.usageInfo,(0,
j.P7)().editorInSeparateTab,{ShowNotification:ag,ShowConfirmationDialog:aB,ShowErrorDialog:ah,ShowDataViewModeInDetailsPane:aA
},A.m_localization);await ac((()=>f),d)}}async function aA(a,b,c,d){
if(!c&&7!==a.type&&1!==a.type&&2!==a.type&&5!==a.type&&6!==a.type&&4!==a.type)return;D=a,L=!1
;const f="stand-alone"===A.m_rf_page_status.extensionMode,g="stand-alone"===A.m_rf_page_status.mode
;if(1!==a.type&&4!==a.type)if(2!==a.type)if(7!==a.type)5!==a.type&&6!==a.type||await aH(a,b,"","",d);else{const f=b?null:{
...
j.P7)().editorInSeparateTab,A.m_localization,{ShowNotification:ag,ShowConfirmationDialog:aB,ShowErrorDialog:ah,
ShowModalDialog:aF,GetSafenoteCommands:aj,CopyTextToClipboard:aC,OnCreate:async b=>{
const c=await A.m_rf_api.data.GetDataItem(b.path,4,null,null);A.m_rf_manager.OnEditorItemCreated(a,b),await aA(b,c,!1,d)}})
;await ac((()=>g),d)}else{
const c=(await(0,e.As)(m.Aj,300,d)).BookmarkViewerView(a,b,A.m_rf_data_item_images,A.m_rf_api.data,A.m_rf_api.usageInfo,A.m_rf_commands,!0,f,(0,
j.P7)().editorInSeparateTab,C.m_localization,C.m_clipboard,{ShowNotification:ag,ShowConfirmationDialog:aB,ShowErrorDialog:ah,
GetBookmarkCommands:ai,ShowDataEditModeInDetailsPane:az});await ac((()=>c),d)}else{const c=(await(0,
e.As)(m.Rj,300,d)).LoginViewerView(a,b,A.m_rf_data_item_images,A.m_view_api,A.m_rf_api.data,A.m_rf_api.usageInfo,A.m_rf_commands,A.password_audit_service,A.m_rf_api.securityWarningsManager,A.m_breach_mon_service,!0,f,g,(0,
j.P7)().editorInSeparateTab,!1,C.m_localization,C.m_clipboard,{ShowNotification:ag,ShowConfirmationDialog:aB,ShowErrorDialog:ah,
GetLoginCommands:ai,GetDataLoginPasswordStrength:ax,GetTextByPasswordStrength:ay,ShowDataEditModeInDetailsPane:az,
CopyTextToClipboardWithAutoClear:aC,OpenSecurityCenter:()=>aD(a.path),OpenDataBreachMonitoring:aE});await ac((()=>c),d)}}
async function aB(a,b,c,d){return aF((0,l.Sw)((0,v.TT)(P),(0,l.p)((0,l.dK)("dialog-modal",a,{onCancel:(a,b)=>a(!1),
onEscape:(a,b)=>a(!1),onClickOutside:null}),(()=>(0,k._3)((async(a,e)=>x("div",{className:"content"
},"string"==typeof b?x("div",{className:"confirmation-text"},b):b,x("div",{className:"buttons-bar"},x("div",{className:"button",
onclick:()=>a(!1)},c),x("div",{className:"button default-button",onclick:()=>a(!0)},d)))))))),null)}async function aC(a,b){
await C.m_clipboard.WriteText(a),W=a,b&&function(a){X.Start((async b=>{await(0,t.Gu)(a,b);let c="";try{
c=await C.m_clipboard.ReadText()}catch(d){}if(W===c||!c)try{await C.m_clipboard.WriteText(" "),W=""}catch(d){}}))}(b)}
function aD(a){A.m_rf_manager.OpenSecurityCenterFromEditor("security-center-all",a)}function aE(a){
A.m_rf_manager.OpenDataBreachMonitoring(a)}async function aF(a,b){Y=a;try{return await a.Execute(b)}finally{Y=null}}
async function aG(a,b,c,d,f){D=a,L=!0
;const g=(await(0,e.As)(m.ow,300,f)).IdentityEditorView(a,b,c,d,!1,A.m_rf_api.data,A.m_rf_api.usageInfo,C.m_identity_view_structure_loader,A.m_initial_identity_provider,(0,
j.P7)().editorInSeparateTab,A.m_localization,{ShowNotification:ag,ShowConfirmationDialog:aB,ShowErrorDialog:ah,
ShowDataViewModeInDetailsPane:aH,OnRename:A.m_rf_manager.OnEditorItemRenamed});await ac((()=>g),f)}async function aH(a,b,c,d,f){
D=a,L=!1
;const g=(await(0,e.As)(m.ow,300,f)).IdentityViewerView(a,b,c,d,A.m_rf_api.data,A.m_rf_api.usageInfo,C.m_identity_view_structure_loader,A.m_initial_identity_provider,A.m_breach_mon_service,A.m_rf_api.securityWarningsManager,A.m_rf_commands,!0,(0,
j.P7)().editorInSeparateTab,A.m_localization,{ShowNotification:ag,ShowConfirmationDialog:aB,ShowErrorDialog:ah,
GetIdentityCommands:ak,ShowDataEditModeInDetailsPane:aG,CopyTextToClipboardWithAutoClear:aC,
OnRename:A.m_rf_manager.OnEditorItemRenamed,OnViewInNewTab:a=>{A.m_rf_manager.OnOpenEditor(a,!1,!1,!0)},
OpenDataBreachMonitoring:aE});await ac((()=>g),f)}async function aI(a,b,c){D=a,L=!0;let d="",f=""
;if(b.m_groups.length&&b.m_groups[0]){const a=b.m_groups[0]
;d=a.m_name,a.m_instances.length&&a.m_instances[0]&&(f=a.m_instances[0].m_name)}const g=(await(0,
...
j.P7)().editorInSeparateTab,A.m_localization,{ShowNotification:ag,ShowConfirmationDialog:aB,ShowErrorDialog:ah,
ShowDataViewModeInDetailsPane:aH,OnRename:A.m_rf_manager.OnEditorItemRenamed});await ac((()=>g),c)}}const C=630,D=590
;let E=null,F=!0,G=!1;const H=1220,I=500;function J(a){if(E){let b=Math.max(E,a);return b=Math.min(b,window.innerWidth-D),
b=Math.max(b,E),E=null,G=!0,b}let b=Math.max(C,a);return b=Math.min(b,window.innerWidth-D),b=Math.max(b,C),G=!1,b}function K(a){
const b=Math.max(C,a);A.m_rf_manager.GetController(1).Collapse(b)}window.addEventListener("resize",(()=>{if(!A)return
;if(!A.m_rf_manager.IsInlineEditorShown())return;const a=A.m_main_view_html_elements.editor;if(!a)return
;const b=A.m_main_view_html_elements.header,c=A.m_main_view_html_elements.mainFrame
;if(window.innerWidth<H)return a.style.width="",a.style.left="",b.style.width="",void(c.style.width="");K(a.clientWidth)
;const d=J(a.clientWidth);a.style.width=(0,q.Md)(d),a.style.left=(0,q.Md)(window.innerWidth-d),b.style.width=(0,
...
m_is_note_field:!1,ApplyChange:a=>Object.assign(Object.assign({},a),{m_goto_url:s})}})
...
m_is_note_field:!1,ApplyChange:a=>Object.assign(Object.assign({},a),{m_match_url:u})}});const w=new Map;a.m_fields.forEach((a=>{
w.set(C(a),a)}));const x=new Map;null==b||b.m_fields.forEach((a=>{x.set(C(a),a)}));for(const[k,B]of x){const a=w.get(k)
;if(!a)continue;const b=null!==(g=a.m_value)&&void 0!==g?g:"";b!==(null!==(h=B.m_value)&&void 0!==h?h:"")?b&&(r.push({
m_field_group:null,m_field_group_icon:null,m_field_change:{m_time_secs:e,m_field_unique_id:k,
...
;const d=[...b.m_fields],e=d.find((a=>C(a)===k));return e?(e.m_value=null!==(c=a.m_value)&&void 0!==c?c:"",
Object.assign(Object.assign({},b),{m_fields:d})):b}}}),w.delete(k)):w.delete(k)}for(const k of w.values()){
if(!k.m_value)continue;const a=C(k);r.push({m_field_group:null,m_field_group_icon:null,m_field_change:{m_time_secs:e,
m_field_unique_id:a,m_field_display_name:await A(null!==(m=k.m_name)&&void 0!==m?m:n.PY),
m_prev_value:null!==(o=k.m_value)&&void 0!==o?o:"",m_current_value:null,m_is_password_field:2===k.m_type,m_is_note_field:!1,
ApplyChange:b=>{var c;const d=[...b.m_fields],e=d.find((b=>C(b)===a))
;return e?e.m_value=null!==(c=k.m_value)&&void 0!==c?c:"":d.push(k),Object.assign(Object.assign({},b),{m_fields:d})}}})}
...
ApplyChange:a=>Object.assign(Object.assign({},a),{m_note:y})}}),r;async function A(a){
...
m_is_note_field:!1,ApplyChange:a=>Object.assign(Object.assign({},a),{m_goto_url:h})}})
...
ApplyChange:a=>Object.assign(Object.assign({},a),{m_note:j})}}),g}async function h(a,b,c){var d,e
...
ApplyChange:a=>Object.assign(Object.assign({},a),{m_note:f})}}]:[]}async function i(a,b,c){var e,f,g,h,i,j,l,m,n,p,q,r
;b=null!=b?b:{m_groups:[],m_options:{}};const s=[],u=new Set;for(const d in a.m_options)u.add(d)
;for(const d in b.m_options)u.add(d);for(const d of u.keys()){
...
m_current_value:h,m_prev_value:g,m_is_password_field:!1,m_is_note_field:!1,ApplyChange:a=>{const b=Object.assign({},a.m_options)
;return b[d]=g,Object.assign(Object.assign({},a),{m_options:b})}}})}const v=new Map;a.m_groups.forEach((a=>{v.set(a.m_name,a)}))
;const w=new Map;b.m_groups.forEach((a=>{w.set(a.m_name,a)}));const x=new Set([...a.m_groups.map((a=>{var b
;return null!==(b=a.m_name)&&void 0!==b?b:""})),...b.m_groups.map((a=>{var b;return null!==(b=a.m_name)&&void 0!==b?b:""}))])
;for(const d of x){
...
;return C(c,a.m_name,b.m_name,null!==(d=e.m_name)&&void 0!==d?d:"",e.m_value,e.m_custom_matches)}}})}else{
...
m_is_note_field:!1,ApplyChange:c=>{var e
;return C(c,d,b.m_name,null!==(e=a.m_name)&&void 0!==e?e:"",a.m_value,a.m_custom_matches)}}});else{const a=new Map
;b.m_fields.forEach((b=>{var c;a.set(null!==(c=b.m_name)&&void 0!==c?c:"",b)}));const f=new Map;e.m_fields.forEach((a=>{var b
;f.set(null!==(b=a.m_name)&&void 0!==b?b:"",a)}));const g=new Set([...b.m_fields.map((a=>{var b
...
var c
;return C(a,d,b.m_name,null!==(c=null==g?void 0:g.m_name)&&void 0!==c?c:"",null==g?void 0:g.m_value,null==g?void 0:g.m_custom_matches)
...
}function C(a,b,c,d,e,f){const g=[...a.m_groups],h=Object.assign(Object.assign({},a),{m_groups:g})
;let i,j=g.findIndex((a=>a.m_name===b));if(j>=0){const a=g[j];i=Object.assign({},a),g[j]=i}else i={m_name:b,m_instances:[]},
g.push(i);const k=[...i.m_instances];i.m_instances=k;let l,m=k.findIndex((a=>a.m_name===c));if(m>=0){const a=k[m]
;l=Object.assign({},a),k[m]=l}else l={m_name:c,m_fields:[]},k.push(l);const n=[...l.m_fields];l.m_fields=n
;let o,p=n.findIndex((a=>a.m_name===d));if(p>=0){const a=n[p];o=Object.assign({},a),n[p]=o}else o={m_name:d},n.push(o)
;return o.m_value=e,o.m_custom_matches=f,h}}}}(a,null);H=(0,h.d)(b,d.g_rf_editor_context.m_localization,y,{ApplyChanges:L,
Cancel:g,CloseOnSuccess:M,ShowError:N,ShowFieldCopiedNotification:O});const e=v("div",null,await H.Create());F.appendChild(e),
H.OnAfterShow(),A.onDataChanged.Add(P)}),(()=>()=>{}),300,i)}function P(a){
for(const c of a)6===c.event&&(1!==c.type&&3!==c.type||(0,p.fI)((async()=>{await Q(b)&&K()})()),2===c.type&&(0,p.fI)((async()=>{
await R(b)&&K()})()),7===c.type&&(0,p.fI)((async()=>{await S(b)&&K()})()),5!==c.type&&6!==c.type||(0,p.fI)((async()=>{
await T(b)&&K()})()))}async function Q(b){var c,d,e,f;const g=await A.GetDataItem(a.path,4,null,null)
...
;let f=Object.assign({},e);for(const a of b)f=a.ApplyChange(f);await d.g_rf_editor_context.m_rf_api.data.PutDataItem(a.path,f,c)
}function M(){
(0,e.Fp)(B("RestoreUserDataDialog_RestoreSuccess_Caption3")),(0,p.fI)(d.g_rf_editor_context.m_rf_manager.SwitchToEditor(a,!1,!1))
